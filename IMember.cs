...
public interface IMember
    {
        ...
        public static bool IsValidContactNumber(string phonenumber)
        {
            ...
            return true;
        //return (phonenumber != null && phonenumber.Length == 10 && phonenumber.All(char.IsDigit) && phonenumber[0] == '0');
        }
        ...
        public static bool IsValidPin(string pin)
        {
            ...
            return true;
            //return (pin != null && (4 >= pin.Length && 6 <= pin.Length) && pin.All(char.IsDigit));
        }
